...
const VideoCard = memo(
  ({ data, userSpecificVideos = true, addVideoBtn = false }) => {
    ...
    } = useGetAllUserVideosQuery({ userId: data }, { skip: !data });
        ...
        {addVideoBtn && (
          <div className="w-full ml-4">
            <button
              ...
              className="w-fit mt-4 inline-flex items-center gap-x-2 bg-[#08e6f5] px-3 py-2 font-semibold text-black"
            >
              <svg
                ...
                >
                  ...
                  <div className="mx-auto flex w-full max-w-3xl flex-col gap-y-4 p-4 h-auto overflow-y-auto">
                    <div className="w-full border-2 border-dashed px-4 py-12 text-center">
                      ...
                      <h1 className="text-2xl font-semibold font-sans text-red-600">
                        Limit (100MB)
                      </h1>
