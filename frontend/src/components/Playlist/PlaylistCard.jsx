...
function PlaylistCard({ data, editAndDelete = false }) {
  ...
  const { data: playlistsData, refetch } = useGetUserPlaylistsQuery(data, {
    skip: !data,
  });
  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))] gap-4 p-4">
      {playlists?.length > 0 ? (
        [...playlists].reverse().map((playlist, idx) => (
          <div key={playlist._id || idx} className="w-full">
                ...
                <div className="absolute inset-0">
                  <img
                    src={
                      ...
                      "https://wallpaperaccess.com/full/2861682.jpg"
                    }
                    alt={playlist?.name}
            ...
            {isOpen && selectedPlaylist && (
              ...
              >
                ...
                >
                  <div
                    className="relative flex h-auto w-full max-w-3xl flex-col rounded-lg border bg-black shadow-lg"
