  ...
  return (
    <>
      <div className="h-screen overflow-y-auto bg-[#121212] text-white">
        <h1 className="sm:ml-[70px] text-4xl sm:text-5xl font-bold p-4 bg-gradient-to-r from-gray-100 via-gray-500 to-gray-800 bg-clip-text text-transparent">
          Liked Videos
        </h1>
                ...
                videos?.map((video, idx) => (
                  <div key={video.videoDetails._id || idx} className="w-full">
                    {video?.videoDetails.isPublished ? (
                      <div
                        key={video.videoDetails._id || idx}
                        className="w-full"
                      >
