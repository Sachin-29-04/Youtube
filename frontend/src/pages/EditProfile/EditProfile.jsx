          ...
          <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0">
            <div className="relative min-h-[150px] w-full pt-[16.28%]">
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                ...
                <label
                  htmlFor="coverImage"
                  className="inline-block h-10 w-10 cursor-pointer rounded-lg bg-white/60 p-1 text-[#08e6f5] hover:bg-white"
                >
                  <svg
              ...
              <div className="flex flex-wrap gap-4 pb-4 pt-6">
                <div className="relative -mt-12 inline-block h-28 w-28 shrink-0 overflow-hidden rounded-full border-2">
                  ...
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                    ...
                    <label
                      htmlFor="avatar"
                      className="inline-block h-8 w-8 cursor-pointer rounded-lg bg-white/60 p-1 text-[#08e6f5] hover:bg-white"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                ...
                <div className="inline-block">
                  <Link
                    to={`/mychannel/${channel?.username}`}
                    className="group/btn mr-1 flex w-full items-center gap-x-2 bg-[#08e6f5] px-3 py-2 text-center font-bold text-black shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e] sm:w-auto"
                  >
                    View channel
                  </Link>
                </div>
