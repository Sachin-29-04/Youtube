...
function Admin() {
  ...
  const [togglePublishStatus, { isLoading: toggleLoading }] =
    useTogglePublishStatusMutation();
  ...
  return (
    <>
      <div className="h-screen overflow-y-auto bg-[#121212] text-white">
        <h1 className="sm:ml-[70px] text-4xl sm:text-5xl font-bold pl-4 pt-4 bg-gradient-to-r from-gray-100 via-gray-500 to-gray-800 bg-clip-text text-transparent">
          Admin Panel
        </h1>
            ...
            <div className="flex flex-wrap justify-between gap-4">
              <div className="block">
                <h1 className="text-2xl font-bold">
                  Welcome Back,{" "}
                  <span className="capitalize">{stats?.username}</span>
                </h1>
              ...
              <div className="block">
                <button
                  ...
                  className="inline-flex items-center gap-x-2 bg-[#08e6f5] px-3 py-2 font-semibold text-black"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                        ...
                        <td className="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                          <div className="flex justify-center">
                            {video?.isPublished ? (
                              ...
                              <span className="inline-block rounded-2xl border px-1.5 py-0.5 border-red-600 text-red-600">
                                Unpublished
                              </span>
                            )}
                          </div>
