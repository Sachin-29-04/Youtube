        ...
        <div className="text-white fixed inset-y-0 right-0 flex w-full max-w-xs shrink-0 translate-x-full flex-col border-l border-white bg-[#121212] duration-200 hover:translate-x-0 peer-focus:translate-x-0 sm:static sm:ml-4 sm:w-auto sm:translate-x-0 sm:border-none">
          ...
          <ul className="my-4 flex w-full flex-wrap gap-2 px-4 sm:hidden">
            <li className="w-full">
              <Link
                to={"/"}
                className="flex w-full items-center justify-start gap-x-4 border border-white px-4 py-1.5 text-left hover:bg-[#08e6f5] hover:text-black focus:border-[#08e6f5] focus:bg-[#08e6f5] focus:text-black"
              >
            ...
            <li className="w-full">
              <Link
                to={`/mychannel/${userData?.username}`}
                className="flex w-full items-center justify-start gap-x-4 border border-white px-4 py-1.5 text-left hover:bg-[#08e6f5] hover:text-black focus:border-[#08e6f5] focus:bg-[#08e6f5] focus:text-black"
              >
                <span className="inline-block w-full max-w-[20px] group-hover:mr-4 lg:mr-4">
                  <svg
          ...
          <div className="mb-8 mt-auto flex w-full flex-wrap gap-4 px-4 sm:mb-0 sm:mt-0 sm:items-center sm:px-0">
            ...
            {!isAuthenticated ? (
              <>
                <Link
                  to={"/login"}
                  className="mr-1 w-full bg-[#08e6f5] px-3 py-2 text-center font-bold text-black shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e] md:w-auto"
                >
                  Log in
                </Link>
                <Link
              ...
              <div className="flex w-full items-center gap-4 md:w-auto">
                <Link
                  to={`/mychannel/${userData?.username}`}
                  className="mr-1 w-full rounded-full shadow-[5px_5px_0px_0px_#4b5563] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4b5563] flex gap-4 text-left sm:items-center px-3 py-2 sm:px-0 sm:py-0"
                >
                  <img
                    src={userData?.avatar}
                ...
                <button
                  ...
                  className="mr-1 w-full bg-red-600 px-3 py-2 text-center font-bold text-white shadow-[5px_5px_0px_0px_#4b5563] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4b5563] md:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
                >
